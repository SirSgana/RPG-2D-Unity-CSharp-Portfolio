...
public class Inventory_Item
{
    ...
    public Inventory_Item(Item_DataSO itemData)
    {
        ...
        itemId = itemData.itemName + " - " + Guid.NewGuid(); //Required for accessory if i equip the same and i remove one
                                                     // player stats will be still with one due to different ID
    }
